function qkdInput = BasicBB84Alice2DPresetReverse()
...
% measuremnts are.
descriptionModule = QKDDescriptionModule(@BasicBB84Alice2DDescriptionFuncReverse);
...
channelModule = QKDChannelModule(@BasicBB84Alice2DChannelFuncReverse);
