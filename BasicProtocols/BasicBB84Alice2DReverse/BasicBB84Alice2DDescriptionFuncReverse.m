function [newParams,modParser] = BasicBB84Alice2DDescriptionFuncReverse(params, options,debugInfo)
...
proj0 = kron(kron(eye(dimB),diag([1,0])),eye(dimB));
proj1 = kron(kron(eye(dimB),diag([0,1])),eye(dimB));
keyProj = {proj0,proj1};
