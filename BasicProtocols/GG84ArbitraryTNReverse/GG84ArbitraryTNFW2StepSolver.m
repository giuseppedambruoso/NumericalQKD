function [relEntLowerBound,modParser] = GG84ArbitraryTNFW2StepSolver(params,options,debugInfo)
...
% * blocdkDiagonal (false): Tells the solver whether to set up rhoAB to be
...
optionsParser.addOptionalParam("maxGap",1e-7,@(x) x>0);
